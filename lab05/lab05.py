...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    target_city = make_city("target_point", lat, lon)
    distance_from_a = distance(target_city, city_a)
    distance_from_b = distance(target_city, city_b)
    return get_name(city_a) if distance_from_a < distance_from_b else get_name(city_b)
